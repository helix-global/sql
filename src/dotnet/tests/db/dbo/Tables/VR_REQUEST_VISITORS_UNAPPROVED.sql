CREATE TABLE [dbo].[VR_REQUEST_VISITORS_UNAPPROVED] (
    ...
    CONSTRAINT [FK_VR_REQUEST_VISITORS_UNAPPROVED_VNESHID] FOREIGN KEY ([VNESHID]) REFERENCES [dbo].[VR_REQUEST] ([ID]) ON DELETE CASCADE
);


GO
CREATE NONCLUSTERED INDEX [IX_VR_REQUEST_VISITORS_UNAPPROVED]
    ON [dbo].[VR_REQUEST_VISITORS_UNAPPROVED]([VNESHID] ASC);
