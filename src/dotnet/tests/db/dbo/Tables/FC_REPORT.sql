...
CREATE NONCLUSTERED INDEX [IX_FC_REPORT_TOTROUBLEID]
    ON [dbo].[FC_REPORT]([TOTROUBLEID] ASC) WHERE ([TOTROUBLEID] IS NOT NULL);


GO
CREATE NONCLUSTERED INDEX [IX_FC_REPORT_S_S]
    ON [dbo].[FC_REPORT]([S_S] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_FC_REPORT_S_CDT]
    ON [dbo].[FC_REPORT]([S_CR] ASC, [S_CDT] ASC);
...
CREATE NONCLUSTERED INDEX [IX_FC_REPORT_DEVICEID]
    ON [dbo].[FC_REPORT]([DEVICEID] ASC) WHERE ([DEVICEID] IS NOT NULL);


GO
CREATE NONCLUSTERED INDEX [IX_FC_REPORT_DD]
    ON [dbo].[FC_REPORT]([FAILUREDATE] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_FC_REPORT]
    ON [dbo].[FC_REPORT]([PARENTID] ASC) WHERE ([PARENTID] IS NOT NULL);
