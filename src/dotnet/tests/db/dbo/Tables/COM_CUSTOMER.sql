CREATE TABLE [dbo].[COM_CUSTOMER] (
    ...
    CONSTRAINT [PK__COM_CUST__3214EC2740F9A68C] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90),
...
GO
GRANT UPDATE
    ON OBJECT::[dbo].[COM_CUSTOMER] TO [IPG-DOMAIN\IPGL_Integr_MSCRM]
    AS [dbo];


GO
GRANT UPDATE
    ON OBJECT::[dbo].[COM_CUSTOMER] TO [EMEA\DEPCS]
    AS [dbo];
