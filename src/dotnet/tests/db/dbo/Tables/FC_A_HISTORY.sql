CREATE TABLE [dbo].[FC_A_HISTORY] (
    ...
    CONSTRAINT [PK__FC_A_HIS__3214EC27713DB68B] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90),
...
CREATE NONCLUSTERED INDEX [IX_FC_A_HISTORY_FRID]
    ON [dbo].[FC_A_HISTORY]([FRID] ASC) WITH (FILLFACTOR = 90);


GO
CREATE NONCLUSTERED INDEX [IX_FC_A_HISTORY_1]
    ON [dbo].[FC_A_HISTORY]([NND] ASC) WITH (FILLFACTOR = 90);
