CREATE TABLE [dbo].[DEF_REPORTS] (
    ...
    CONSTRAINT [PK__DEF_REPO__3214EC27164452B1] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90),
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_DEF_REPORTS_1]
    ON [dbo].[DEF_REPORTS]([LABEL] ASC) WITH (FILLFACTOR = 90);


GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_DEF_REPORTS]
    ON [dbo].[DEF_REPORTS]([OID] ASC) WITH (FILLFACTOR = 90);
