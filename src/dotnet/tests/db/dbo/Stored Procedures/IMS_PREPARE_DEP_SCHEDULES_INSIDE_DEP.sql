...
CREATE PROCEDURE [dbo].[IMS_PREPARE_DEP_SCHEDULES_INSIDE_DEP] 
...
BEGIN
   ...
   insert into IMS_DEP_SCHEDULE (GID,S_CR,S_CDT,S_S,SCHEDULEID,DEPID, REMARK)
   select newid(),@aUserID, @now, 2130030 /* сразу за-approve-ленное */, @aContextID, M.DEPID, 'Automaticly approved as training inside Department'
   from (
