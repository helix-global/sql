CREATE procedure [dbo].[PR_CHANGE_MODEL_IFNEED2]  @OperationID int, @aUserID int
as 
set nocount on
...
begin
  ...
  exec PR_CHANGE_PN_2NAVI 1, @OperationID, @aUserID, @now
...
begin
  ...
  exec PR_CHANGE_PN_2NAVI 2, @OperationID, @aUserID, @now
