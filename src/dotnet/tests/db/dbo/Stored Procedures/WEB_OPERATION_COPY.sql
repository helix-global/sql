CREATE PROCEDURE [dbo].[WEB_OPERATION_COPY] 
  @UserID int, @aModelCode nvarchar(16), @aSN nvarchar(50), @aOrder nvarchar(50), @aOperationCode nvarchar(50)
AS
BEGIN
declare @OperIDToCopy int
set @OperIDToCopy = dbo.WEB_FIND_OPERATION_2_COPY(@UserID, @aModelCode, @aSN, @aOrder, @aOperationCode)
