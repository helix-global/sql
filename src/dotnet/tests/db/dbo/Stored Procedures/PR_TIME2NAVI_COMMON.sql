CREATE procedure [dbo].[PR_TIME2NAVI_COMMON] @OperID int, @Mode int, @aUserID int, @aDate datetime
...
declare @timings table (EMPLNUMBER nvarchar(20),QUANTITY int,QUALIFICATION int,OPERCODE nvarchar(20))
