create function [dbo].[CS_HPLA_RP_ORDERED_WITHSTAGES2](@mtID int, @UserID int, @aMode int, @date date, @avgMonthPeriod int, @dBeg datetime, @dEnd datetime)
...
begin
  ...
  */
    ...
    from dbo.CS_HPLA_RP_ORDERED2(@mtID, @UserID, @aMode, @dBeg, @dEnd) A
