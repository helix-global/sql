...
-- Description:	Get list of ALL Absence Request for Mobile TimeLine 
-- =============================================
CREATE FUNCTION [dbo].[MOBILE_VACATIONS_TIMELINE](@UserID int  /*, @UserName varchar(250) = null*/)
...
BEGIN
	...
	where 
		...
		-- KB4360
		and dbo.DEF_USERINGROUP4(@UserID,'MNGD', getdate()) <> 1 /* НЕ! Mangmend Directors - Фомин, Машкин*/
		and @UserID <> 857 /* НЕ! Щербаков */ 
