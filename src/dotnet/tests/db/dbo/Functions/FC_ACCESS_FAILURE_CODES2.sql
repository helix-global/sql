create function [dbo].[FC_ACCESS_FAILURE_CODES2] (@aUserID int,@aMode int,@aDate datetime)
returns @res table (ID int)
as 
begin
/* выдает ID типов моделей на которые можно видеть коды _отказа_ */
/* от FC_ACCESS_FAILURE_CODES отличается добавкой типом моделей в которых есть свои модели */
