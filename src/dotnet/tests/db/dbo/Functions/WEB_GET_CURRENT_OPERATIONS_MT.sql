CREATE function [dbo].[WEB_GET_CURRENT_OPERATIONS_MT](@UserID int, @aMTName nvarchar(300), @aModelCode nvarchar(50), @aOperationCode nvarchar(50))
returns @res table 
...
left join PR_MODELTYPE MT with (nolock) on MT.ID = T1000224.TYPEID
