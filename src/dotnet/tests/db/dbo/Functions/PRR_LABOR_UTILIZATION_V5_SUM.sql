CREATE FUNCTION [dbo].[PRR_LABOR_UTILIZATION_V5_SUM](@DepID int, @aMonths int, @IncludeCurrentMonth int)
RETURNS 
@res TABLE 
(
     DEPID int    
...
BEGIN
    ...
    from dbo.PRR_LABOR_UTILIZATION_V5(@DepID, @aMonths, null, @IncludeCurrentMonth) A
