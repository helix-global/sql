...
CREATE FUNCTION [dbo].[PR_PRODUCTION_PLAN_DATE_HISTORY]
(
        @DepID INT
       ,@dBeg DATETIME
       ,@dEnd DATETIME
...
BEGIN
    ...
    declare @dev table (ID int,EXPDATE datetime,WEEKN int,MAPID int, REVID int,ERR int,MANH decimal(10,4), COMPLETED INT , DEV_QTY INT PRIMARY KEY(ID, WEEKN, EXPDATE))
