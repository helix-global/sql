CREATE function [dbo].[PR_MODELS_TO_BOMITEM2](@OperID int, @BomID int, @OnDate datetime)  
 returns @res table(ID INT,SOURCE_TYPE int)
as 
begin  
  /* v.2 добавлен SOURCETYPE для сортировки - что из ревизии, а что из типа моделей BOM Position */
