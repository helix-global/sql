create FUNCTION [dbo].[PRR_LABOR_UTILIZATION_V5_2_tempYEAR](@DepID int, @aMonths int, @OnlyMonth date, @IncludeCurrentMonth int ,@mode int)
RETURNS 
@res TABLE 
(
     EMPLID int    
