CREATE function [dbo].[WEB_GET_DEVICE_COMPONENTS](@UserID int, @aDeviceID int, @aBOMItemNameMask nvarchar(max))
...
begin
  ...
  select A.ID,C.CODE,A.SN,isnull(A.PARTQUANTITY,1),B.NAME,A.PARTID,A.MODELID
