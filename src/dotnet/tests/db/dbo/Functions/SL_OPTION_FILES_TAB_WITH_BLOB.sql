CREATE function [dbo].[SL_OPTION_FILES_TAB_WITH_BLOB] ()
...
insert into @res (ID,GID,S_CR,S_CDT,S_MR,S_MDT,OPTID,FILENAME,FILEDATE,FILESIZE,FILEDESC,FILEGROUP, FILESOURCE, FILEBLOB)
SELECT A.ID, A.GID, A.S_CR, A.S_CDT, A.S_MR, A.S_MDT, A.OPTID, A.FILENAME, A.FILEDATE, A.FILESIZE, A.FILEDESC, A.FILEGROUP, 1, A.FILEBLOB
...
insert into @res (ID,GID,S_MDT,OPTID,FILENAME,FILEDATE,FILESIZE,FILEDESC,FILEGROUP,FILESOURCE,FILESOURCEID,FILEBLOB)
select A.ID,T.GID
