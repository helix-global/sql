...
CREATE function [dbo].[PR_IS_MY_CO_NEW_TEST3](@UserID int,@OnDate datetime)  
...
begin  
  ...
  select top 1 @PlanID = RP.ID 
   ...
   begin
	...
	insert into @Groups (ID,ORDTYPE)  
    select distinct v.OPERGRID,0
