CREATE FUNCTION [dbo].[WEB_FIND_OPERATION_2_JOIN_MT](@UserID int, @aMTName nvarchar(300), @aCode nvarchar(16), @aSN nvarchar(50), @aOrder nvarchar(50), @aOperationCode nvarchar(50))
RETURNS int
AS
BEGIN
