CREATE FUNCTION [dbo].[PRR_LABOR_UTILIZATION_V5_2_SUM](@DepID int, @aMonths int, @IncludeCurrentMonth int, @mode int)
RETURNS 
@res TABLE 
(
     DEPID int    
...
BEGIN
    ...
    */
    ...
    from dbo.PRR_LABOR_UTILIZATION_V5_2(@DepID, @aMonths, null, @IncludeCurrentMonth,@mode) A
