...
-- KB4660:2024-12-16: Refactored. Optimized.
-- KB4660:2024-06-26: Refactored. Updated to use [FC_GETCHILD_FARS_CACHED] instead of [FC_GETCHILD_FARS].
CREATE function [dbo].[FC_ACCESS_REPORT_TAB2](@aUserID int, @aMode int, @aDate datetime)
...
begin
  ...
  --declare @status int;
  --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]',null,null)
  ...
  begin
    --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block01',null,null)
    insert into @res
      select [ID]
  ...
  begin
    --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block02',null,null)
    insert into @res
      select [ID]
      from [dbo].[FC_REPORT] with(nolock)
    --set @status=[CLR_DEV].[dbo].[fn_trace_leave](null)
  ...
  begin
    ...
    begin
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block03',null,null)
      insert into @res([ID])
        select distinct
          [b].[ID]
      ...
      begin
        --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block04,Block05',null,null)
       ...
       ;with [T] as
          ...
          select
            ...
            ,0 [LEVEL]
          from @res [a]
            inner join [dbo].[FC_REPORT] [b] with(nolock) on [b].[PARENTID]=[a].[ID]
          union all
          select
             [a].[ID] [CHILDID]
            ,[b].[LEVEL]+1 [LEVEL]
          from [dbo].[FC_REPORT] [a] with(nolock)
            inner join [T] [b] on [b].[CHILDID]=[a].[PARENTID]
          where [b].[LEVEL]<100
            and [a].[ID]<>[a].[PARENTID]
          )
      ...
      begin
        ...
        --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block06',null,null)
        insert into @ChildsT
          select distinct
            [A].[ID]
          from [dbo].[FC_REPORT] [A] with(nolock)
    ...
    begin
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block07',null,null)
      insert into @res([ID])
        select distinct
          [b].[ID]
        from [dbo].[FC_ACCESS_MODELS](@aUserID,6,@aDate) [a]
      ...
      begin
        --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block08',null,null)
        delete from @ChildsT
        insert into @ChildsT
          select distinct
            [A].[ID]
    ...
    begin
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block09',null,null)
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block09:01',null,null)
      delete from @DepartmentsT
      insert into @DepartmentsT
        select distinct [a].[ID]
        from [dbo].[COM_ACCESS_DEPARTMENTS](@aUserID,1,@aDate) [a]
      --set @status=[CLR_DEV].[dbo].[fn_trace_leave](null)
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block09:02',null,null)
      insert into @res([ID])
        select [A].[ID]
        from [dbo].[FC_REPORT] [A] with(nolock)
    ...
    begin
      ...
      begin
        --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block10,Block11',null,null)
        merge @res [a]
        using
          (
          select distinct [A].[ID]
      ...
      begin
        --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block12',null,null)
        delete from @DepartmentsT
        insert into @DepartmentsT
          select distinct [a].[ID]
          from [dbo].[COM_ACCESS_DEPARTMENTS](@aUserID,3,@aDate) [a]
        --set @status=[CLR_DEV].[dbo].[fn_trace_leave](null)
        --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block13',null,null)
        merge @res [a]
        using
          (
          select [A].[ID]
    ...
    begin
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block14',null,null)
      merge @res [a]
      using
        (
        select distinct [A].[ID]
    ...
    begin
      --set @status=[CLR_DEV].[dbo].[fn_trace_enter]('10000000-0000-0000-0000-000000000000','[dbo].[FC_ACCESS_REPORT_TAB2]:Block15',null,null)
      merge @res [a]
      using
        (
        select distinct [A].[ID]
