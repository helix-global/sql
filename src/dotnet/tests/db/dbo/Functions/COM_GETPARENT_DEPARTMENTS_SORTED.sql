...
CREATE function [dbo].[COM_GETPARENT_DEPARTMENTS_SORTED] (@aID int, @aIncludeInputID int)
returns @res table (ID int, SORT int)
as 
begin
   ...
   if @aIncludeInputID = 1 
      insert into @res (ID, SORT) values (@aID, 0)
   ...
   begin
	   ...
	   begin
		 insert into @res (ID, SORT) values (@ParentID2, @i)
