CREATE FUNCTION [dbo].[PRR_LABOR_UTILIZATION_V3_SUM](@DepID int, @aMonths int, @IncludeCurrentMonth int)
RETURNS 
@res TABLE 
(
	 DEPID int    
...
BEGIN
	...
	from dbo.PRR_LABOR_UTILIZATION_V3(@DepID, @aMonths, null, @IncludeCurrentMonth) A
