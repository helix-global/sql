...
CREATE function [dbo].[WEB_GET_DEVICE_RAW_PARAMS](@UserID int, @aDeviceID int, @aNames nvarchar(max), @skipAccessCheck bit)
...
select P.ID,P.NAME,P.DATATYPE,P.[DESCRIPTION],P.UNITSTR,P.SYMBOL,dbo.PR_DEVICE_RAW_PARAM(A.ID, P.ID),P.PARAMKIND
