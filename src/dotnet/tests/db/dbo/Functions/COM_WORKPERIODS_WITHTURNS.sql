CREATE function [dbo].[COM_WORKPERIODS_WITHTURNS] (@dBeg datetime, @dEnd datetime, @calendar int, @whID int, @emplID int)
returns table 
as 
    return
    with 
    ...
    select dbeg as DBEG, dend as DEND, wturn as WTURN, dt as WDD from worksall2