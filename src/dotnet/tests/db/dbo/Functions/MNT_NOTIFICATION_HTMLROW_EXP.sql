CREATE FUNCTION [dbo].[MNT_NOTIFICATION_HTMLROW_EXP](@MntPlanID int,@OperID int,@EqID int)
...
set @res = '<tr><td>'+@PlanName+'</td><td>'+dbo.COM_FORMAT_DATETIME(@dd,1)+'</td><td>'+isnull(@ModelName,'NA')+'</td><td>'+isnull(@SN,'NA')+'</td><td>'+isnull(@TAGN,'NA')+'</td><td>'+isnull(@WP,'NA')+'</td><td>'+isnull(@dep,'NA')+'</td><td>'+isnull(@respPerson,'NA')+'</td><td>'+isnull(@eqType,'NA')+'</td><td>'+isnull(@remark,'')+'</td></tr>'
