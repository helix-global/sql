...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    {
    internal class FastReportBarcodeConverter : TypeConverter
        {
        public static readonly FastReportBarcodeConverter Instance = new FastReportBarcodeConverter();
    ...
    internal class FastReportBarcodeConverter<T> : TypeConverter
