...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal class FormatConverter : TypeConverter
        ...
        public override Object ConvertTo(ITypeDescriptorContext context,CultureInfo culture,Object value,Type destinationType) {
            ...
            if (destinationType == typeof(FormatBase)) {
        ...
        private static readonly IDictionary<String,Type> Types = new Dictionary<String,Type> {
            ...
            {"Currency", typeof(CurrencyFormat)},
            {"General",  typeof(GeneralFormat) },
            {"Percent",  typeof(PercentFormat) },
            {"Time",     typeof(TimeFormat)    },
            {"Custom",   typeof(CustomFormat)  }
            };
        }
    }