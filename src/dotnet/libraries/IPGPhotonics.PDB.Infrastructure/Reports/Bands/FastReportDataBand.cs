...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal sealed class FastReportDataBand : FastReportBandBase
        {
        ...
        [UsedImplicitly][Field(Order=1000607)] public FastReportBandColumns Columns { get; } = new FastReportBandColumns();
