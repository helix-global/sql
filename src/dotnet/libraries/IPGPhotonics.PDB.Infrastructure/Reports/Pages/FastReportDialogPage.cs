...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal sealed class FastReportDialogPage : FastReportPageBase
        {
        ...
        public IList<FastReportDialogComponentBase> Controls { get; } = new SqlObjectCollection<FastReportDialogComponentBase>();
        ...
        protected override void UpdateReferences(IList<FastReportObject> source) {
            using (var Controls = PrepareChanges(this.Controls)) {
                foreach (var o in source) {
                    if (o is FastReportDialogComponentBase DialogComponentBase) {
