...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal abstract class ComponentBase : Base
        ...
        [UsedImplicitly][Field(Order=1000203,ConverterCulture="en-US")] public Single Width { get; }
        [UsedImplicitly][Field(Order=1000204,ConverterCulture="en-US")] public Single Height { get; }
