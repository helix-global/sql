...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal abstract class FastReportDataConnectionBase : FastReportDataComponentBase
        {
        ...
        [UsedImplicitly] public IList<FastReportTableDataSource> Tables { get; } = new SqlObjectCollection<FastReportTableDataSource>();
        ...
        protected override void UpdateReferences(IList<FastReportObject> source) {
            using (var Tables = PrepareChanges(this.Tables)) {
                foreach (var o in source) {
                    if (o is FastReportTableDataSource DataSource) {
