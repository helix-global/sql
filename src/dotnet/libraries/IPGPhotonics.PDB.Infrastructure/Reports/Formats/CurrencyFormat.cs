...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal sealed class CurrencyFormat : FormatBase,IEquatable<CurrencyFormat>
        {
        ...
        public override void Serialize(XmlWriter writer,String prefix) {
            ...
            if (UseLocale) {
                ...
                writer.WriteAttributeString($"{prefix}.CurrencySymbol",CurrencySymbol);
        ...
        public Boolean Equals(CurrencyFormat other) {
        ...
        public override Boolean Equals(FormatBase other) {
            if (other == null) { return false; }
            if (ReferenceEquals(this, other)) { return true; }
            return Equals(other as CurrencyFormat);
            }
        #endregion
        }
    }