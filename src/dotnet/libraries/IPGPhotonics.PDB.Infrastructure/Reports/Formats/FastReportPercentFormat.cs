...
namespace IPGPhotonics.PDB.Infrastructure.Reports
    ...
    internal sealed class FastReportPercentFormat : FastReportFormatBase,IFastReportLocaleFormat
        {
        ...
        public Boolean Equals(FastReportPercentFormat other) {
        ...
        public override Boolean Equals(FastReportFormatBase other) {
            if (other == null) { return false; }
            if (ReferenceEquals(this, other)) { return true; }
            return Equals(other as FastReportPercentFormat);
            }
        #endregion
        }
    }