...
namespace BinaryStudio.SqlServer.Infrastructure
    {
    public class SqlDecimalConverter : TypeConverter,ISqlValueTypeConverter<Decimal>
        {
        public static readonly SqlDecimalConverter Default          = new SqlDecimalConverter(true);
        public static readonly SqlDecimalConverter DoesNotAllowNull = new SqlDecimalConverter(false);

        public virtual Boolean AllowNull { get; }

        #region ctor{Boolean}
        public SqlDecimalConverter(Boolean AllowNull) {
        ...
        public override Object ConvertTo(ITypeDescriptorContext context,CultureInfo culture,Object value,Type destinationType) {
            ...
            if (destinationType == typeof(Decimal?)) { return ConvertFromObject(culture,value); }
        ...
        public static Decimal? ConvertFromObject(CultureInfo culture,Object value) {
            ...
            if (value is Single  R4) { return (Decimal)R4; }
            ...
            if (!Decimal.TryParse(S,NumberStyles.Float|NumberStyles.AllowDecimalPoint,culture.NumberFormat,out var r))
                {
                return null;
                }
            return r;
        ...
        #endregion
        #region M:ConvertFromObject(Object,Decimal):Decimal
        ...
        public static Decimal ConvertFromObject(CultureInfo culture,Object value,Decimal defaultValue)
            {
            return ConvertFromObject(culture,value).GetValueOrDefault(defaultValue);
            }
        #endregion
        #region M:ISqlValueTypeConverter<Decimal>.ConvertFromObject(Object):Decimal?
        Decimal? ISqlValueTypeConverter<Decimal>.ConvertFromObject(Object value) {
            return ConvertFromObject(null,value);
            }
        #endregion
        #region M:ISqlValueTypeConverter<Decimal>.ConvertFromObject(Object,Decimal):Decimal
        Decimal ISqlValueTypeConverter<Decimal>.ConvertFromObject(Object value,Decimal defaultValue)
            {
        ...
        public override String ToString()
            {
            return $"DecimalConverter{{AllowNull={AllowNull}}}";
            }
        #endregion
        }
    }
