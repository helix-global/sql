...
namespace BinaryStudio.SqlServer.Infrastructure
    {
    public class SqlSingleConverter : TypeConverter,ISqlValueTypeConverter<Single>
        {
        ...
        public static Single? ConvertFromObject(CultureInfo culture,Object value) {
            ...
            if (!Single.TryParse(S,NumberStyles.Float|NumberStyles.AllowDecimalPoint,culture.NumberFormat,out var r))
                {
                return null;
                }
            return r;
        ...
        #endregion
        #region M:ConvertFromObject(Object,Single):Single
        ...
        public static Single ConvertFromObject(CultureInfo culture,Object value,Single defaultValue)
            {
            return ConvertFromObject(culture,value).GetValueOrDefault(defaultValue);
            }
        #endregion
        #region M:ISqlValueTypeConverter<Single>.ConvertFromObject(Object):Single?
        Single? ISqlValueTypeConverter<Single>.ConvertFromObject(Object value) {
            return ConvertFromObject(null,value);
            }
        #endregion
        #region M:ISqlValueTypeConverter<Single>.ConvertFromObject(Object,Single):Single
        Single ISqlValueTypeConverter<Single>.ConvertFromObject(Object value,Single defaultValue)
            {
        ...
        public override String ToString()
            {
            return $"SingleConverter{{AllowNull={AllowNull}}}";
            }
        #endregion
        }
    }
