...
namespace BinaryStudio.SqlServer.Infrastructure
    {
    internal class DEFTableFormatter : SqlObjectFormatter<ISqlTable>
        {
        ...
        public override void WriteTo(ISqlTable source,TextWriter target) {
            ...
            foreach (var column in source.Columns) {
                ...
                idevl[j] = (identity != null)? $" {identity.ToString(DEFConstraintFormatter.Instance)}" : String.Empty;
        ...
        private String FormatDataType(ISqlColumn column) {
            ...
            return column.TypeSpecifier.ToString(DEFTypeSpecifierFormatter.Instance);
            }
        #endregion
        }
    }